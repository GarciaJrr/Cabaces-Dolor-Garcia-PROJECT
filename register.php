...
{
    if (empty($_POST['fullName']) || empty($_POST['studid']) || empty($_POST['email']) || empty($_POST['homeadd'])|| empty($_POST['phnum']) || empty($_POST['newPassword']))
    {
    ...
    { //if true, insert new data
    	...
    	$stmt->bind_param("sss", $fullName, $studid, $email, $homeadd, $phnum, $hash);
   ...
   <div class="rlform-box">
	<div class="rlform-box-inner">
     ...
     <div class="rlform-group">
	  ...
	  <input type="text" name="studid" class="rlform-input" required>
	 </div>
     ...
     <div class="rlform-group">
	  ...
	  <input type="text" name="homeadd" class="rlform-input" required>
	 </div>

     <div class="rlform-group">
	  <label>Phone Number</label>
	  <input type="text" name="phnum" class="rlform-input" required>
	 </div>
